...
![Release](https://img.shields.io/badge/release-v0.0.1--test.3-blue?style=for-the-badge)
...
The following commands are already pinned to `v0.0.1-test.3`. Copy the command
...
```bash
curl -fsSL https://raw.githubusercontent.com/Fouchger/Homelab/test/install-proxmox.sh | bash -s -- --release v0.0.1-test.3
```
...
```powershell
& ([scriptblock]::Create((Invoke-RestMethod 'https://raw.githubusercontent.com/Fouchger/Homelab/test/install-wsl.ps1'))) -Release 'v0.0.1-test.3'
```
...
- [Current release notes](releases/v0.0.1-test.3.md)
