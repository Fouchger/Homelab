...
![Release](https://img.shields.io/badge/release-v0.0.1--test.9-blue?style=for-the-badge)
...
The following commands are already pinned to `v0.0.1-test.9`. Copy the command
...
- [Current release notes](releases/v0.0.1-test.9.md)
