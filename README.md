...
![Release](https://img.shields.io/badge/release-v0.1.0--test.1-blue?style=for-the-badge)
...
The following commands are already pinned to `v0.1.0-test.1`. Copy the command
...
- [Current release notes](releases/v0.1.0-test.1.md)
